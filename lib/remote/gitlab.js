...
GitlabRepo.prototype = {
  ...
  getDependencies: function (namespace, projectName, version) {
    ...
    function getNodeDependencies (namespace, projectName, version) {
      var tree = {};
        ...
        .then(function (json) {
          ...
          return Promise
            .all(json.dependencies.map(function (str) {
              ...
              return getNodeDependencies(parsed.owner, parsed.name, parsed.version)
                .then(function (subTree) {
                  tree.subNodes.push(subTree);
                });
            }))
            .then(function () {
              return tree;
    ...
    return getNodeDependencies(namespace, projectName, version);
  },
